            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        <h2>Book of Love</h2>
                        <p class="d-none d-md-block">Let the pain itself be loved, enhanced, adipisicing. The wise man of their labors. Because of the hardships we have in our offices, the practice of cheering for forgiveness will indeed come to pass.</p>
                    </div>
                </div>
                                            ...
                                            <div class="col-lg-3 col-6">
                                                <div class="book-wrap">
                                                    ...
                                                    <div class="book-title mb-2">
                                                        <a href="{{route('book-details', $book->id)}}">{{ \Illuminate\Support\Str::limit($book->title, 50) }}</a>
                                                    </div>
                                        ...
                                        @foreach($literature_books as $book)
                                            <div class="col-lg-3 col-6">
                                                <div class="book-wrap">
                                                    ...
                                                    <div class="book-title mb-2">
                                                        <a href="{{route('book-details', $book->id)}}">{{ \Illuminate\Support\Str::limit($book->title, 30) }}</a>
                                                    </div>
                                                    <div class="book-author mb-2">
                                                        <small>By <a href="{{route('author', $book->author->slug)}}">{{$book->author->name}}</a></small>
                                                    </div>
