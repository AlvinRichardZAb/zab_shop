...
<section class="header py-2 bg-dark">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="headings">
                    <h3><a href="{{route('bookshop.home')}}" class="text-secondary"><b class="text-primary">ZAB</b> Shop</a></h3>
                </div>
            </div>
            <div class="col-md-4">
    ...
    <a href="{{route('cart')}}" class="text-primary"><i class="fas fa-shopping-cart fa-2x m-1"></i>
